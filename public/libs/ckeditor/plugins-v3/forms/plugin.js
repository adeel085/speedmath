...
CKEDITOR.plugins.add("forms", {
    ...
    init: function (editor) {
        ...
        var addButtonCommand = function (buttonName, commandName, dialogFile) {
            ...
            editor.ui.addButton &&
                editor.ui.addButton(buttonName, {
                    label: lang.common[
                        buttonName.charAt(0).toLowerCase() + buttonName.slice(1)
                    ],
                    command: commandName,
        ...
        addButtonCommand(
            "TextField",
            "semediccustomtextfield",
            dialogPath + "semediccustomtextfield.js?ver=5"
        );
        ...
        editor.on("doubleclick", function (evt) {
            ...
            if (!editor.blockless && element.is("form"))
            ...
            else if (element.is("select")) evt.data.dialog = "select";
            else if (element.is("textarea")) evt.data.dialog = "textarea";
            else if (
                element.is("img") &&
                element.data("cke-real-element-type") == "hiddenfield"
            )
                ...
                if (textfieldTypes[type]) evt.data.dialog = "textfield";
            }
        });
    },
